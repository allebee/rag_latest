...
class DocxParser:
    ...
    def parse(self):
        ...
        current_section = ""
        current_chapter = ""
        current_paragraph = "" # as in hierarchy paragraph
        current_article = ""
        ...
        # Heuristics for headers in paragraphs
        for para in self.doc.paragraphs:
            ...
            # Identify hierarchy
            # Check for bold is a bit complex in python-docx as runs can be mixed. 
            # We will rely mostly on text patterns as they are strong indicators.
            ...
            if re_section.match(text):
                ...
                current_paragraph = ""
                current_article = ""
            elif re_chapter.match(text):
                current_chapter = text
                current_paragraph = ""
                current_article = ""
            elif re_paragraph_header.match(text):
                current_paragraph = text
                current_article = ""
            elif re_article.match(text):
                current_article = text
            
            # Construct metadata context
            context_str = f"{current_section} > {current_chapter} > {current_paragraph} > {current_article}".strip(" >")
            ...
            chunks.append({
                ...
                "metadata": {
                    ...
                    "paragraph_header": current_paragraph,
